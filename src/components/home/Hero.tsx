    ...
    return (
        <div className="flex flex-col md:flex-row gap-5">
            <div className="flex flex-1 flex-col justify-center">
                ...
                <p className="mt-10 text-lg leading-9 text-center md:text-start">
                    Track your spending, set savings goals, and plan for the future—all
                    in one place. Our intuitive personal finance tracker helps you
                    manage your money with ease, so you can make smarter financial
                    decisions and achieve your goals faster.
                </p>
