...
const RegisterForm: React.FC = () => {
    ...
    const form = useForm({
        ...
        validate: {
            firstName: (value) => (value.length >= 1 ? null : 'First name is required.'),
            lastName: (value) => (value.length >= 1 ? null : 'Last name is required.'),
            email: (value) => (/^\S+@\S+$/.test(value) ? null : 'Invalid email.'),
            password: (value) => validatePassword(value),
            confirmPassword: (value, values) => (!value ? "Confirm Password is required." : value === values.password ? null : 'Passwords not matched.'),
            terms: (value) => (value ? null : 'You must agree to the terms and privacy policy.'),
        ...
        <>
            ...
            >
                ...
                <div className="flex gap-2 ">
                    <Checkbox
                        ...
                        description={<span className="!text-gray">
                            By checking this box, I agree to the{" "}
                            <Link href="/privary" className="underline text-navy-blue-300">
                                Terms of Service
                            </Link>{" "}
                            and{" "}
                            <Link href="/privary" className="underline text-navy-blue-300">
                ...
                <div className="flex gap-2 ">
                    <Checkbox
                        ...
                        description={<span className="!text-gray">
                            ...
                            emails from Finomic [Radiant Ways], LLC and its affiliates made by any means or
                            technology for informational, at the
                            email I provided above. I understand that my consent to such emails is
                            not required to use the services of Finomic [Radiant Ways], LLC.
                        </span>}
                        variant="filled"
            ...
            >
                <div className="flex flex-col items-center justify-center p-6 space-y-2">
                    ...
                    <p className='py-1 text-xl text-primary font-semibold'>[Radiant Ways].</p>
