    ...
    try {
        ...
        currentMonthData?.forEach(transaction => {
            if (transaction.transactionType === "TRANSFER") {
                if (transaction.accountId === transaction.toAccountId || transaction.toAccountId === transaction.accountId) {
                    return
                }
            }
            else if (transaction.transactionType === "TRANSFER" && transaction.category === "SAVINGS") {
        ...
        currentMonthOverview.remaining = currentMonthOverview.income - currentMonthOverview.expenses;
        ...
        lastMonthOverview.remaining = lastMonthOverview.income - lastMonthOverview.expenses;
