    ...
    return (
        <div className="space-y-6">
            <div className='flex flex-col gap-2 md:flex-row md:justify-between md:items-center'>
                <div>
                    <h1 className="text-md lg:text-xl xl:text-2xl font-semibold">Analytics</h1>
                    <p>Viewing for the {viewBy} : {viewBy === "month" ? "February" : "2024"}</p>
                </div>
                <Select
                    data={[
            ...
            </div>
            {
                viewBy === 'month' ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        <div>
                            <h1 className="text-2xl lg:text-3xl xl:text-4xl font-semibold">Income</h1>
                            <p className="text-sm text-gray-500">Total income</p>
                            <PieChart data={data} type='INCOME' />
                        </div>
                        <div>
                            <h1 className="text-2xl lg:text-3xl xl:text-4xl font-semibold">Expense</h1>
                            <p className="text-sm text-gray-500">Total expense</p>
                            <PieChart data={data} type='EXPENSE' />
                        </div>
                        <div>
                            <h1 className="text-2xl lg:text-3xl xl:text-4xl font-semibold">Savings</h1>
